...
namespace FoxAndHounds.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Availabilities(int? id)
        {
        ...
        public ActionResult Create([Bind(Include = "Id,UserId,FirstName,LastName")] Employee employee)
        {
            if (ModelState.IsValid)
            {
                ...
                db.SaveChanges();
                return RedirectToAction("Create", "Availabilities");
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,UserId,FirstName,LastName")] Employee employee)
        {
            if (ModelState.IsValid)
            {
